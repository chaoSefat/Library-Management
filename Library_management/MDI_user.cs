...
namespace Library_management
{
    public partial class MDI_user : Form
    {
        ...
        {
            add_students_info ab = new add_students_info();
            ab.Show();
        }

        private void viewStudensInfoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            view_students_info vsi = new view_students_info();
            vsi.Show();
        }
